...
def unet_wreg(input_shape=(128,128,3),
    ...
    down1 = Conv2D(first_filters, (3,3), activation='relu', padding='same', kernel_regularizer=l2(0.001))(inputs)
    down1 = BatchNormalization()(down1)
    down1 = Conv2D(first_filters, (3,3), activation='relu', padding='same', kernel_regularizer=l2(0.001))(down1)
    down1 = BatchNormalization()(down1)
    down1_pool = MaxPooling2D((2,2), strides=(2,2))(down1)
    down1_pool = Dropout(0.25)(down1_pool)
    
    down2 = Conv2D(first_filters*2, (3,3), activation='relu', padding='same', kernel_regularizer=l2(0.001))(down1_pool)
    down2 = BatchNormalization()(down2)
    down2 = Conv2D(first_filters*2, (3,3), activation='relu', padding='same', kernel_regularizer=l2(0.001))(down2)
    down2 = BatchNormalization()(down2)
    down2_pool = MaxPooling2D((2,2), strides=(2,2))(down2)
    down2_pool = Dropout(0.25)(down2_pool)
    
    down3 = Conv2D(first_filters*4, (3,3), activation='relu', padding='same', kernel_regularizer=l2(0.001))(down2_pool)
    down3 = BatchNormalization()(down3)
    down3 = Conv2D(first_filters*4, (3,3), activation='relu', padding='same', kernel_regularizer=l2(0.001))(down3)
    down3 = BatchNormalization()(down3)
    down3_pool = MaxPooling2D((2,2), strides=(2,2))(down3)
    down3_pool = Dropout(0.25)(down3_pool)
    
    center = Conv2D(first_filters*8, (3,3), activation='relu', padding='same', kernel_regularizer=l2(0.001))(down3_pool)
    center = BatchNormalization()(center)
    center = Conv2D(first_filters*8, (3,3), activation='relu', padding='same', kernel_regularizer=l2(0.001))(center)
    center = BatchNormalization()(center)
    
    # up3 = UpSampling2D((2,2))(center)
    up3 = Conv2DTranspose(first_filters*4, (2,2), activation='relu', strides=(2,2), padding='same', kernel_regularizer=l2(0.001))(center)
    up3 = concatenate([up3, down3], axis=3)
    up3 = Dropout(0.25)(up3)
    up3 = Conv2D(first_filters*4, (3,3), activation='relu', padding='same', kernel_regularizer=l2(0.001))(up3)
    up3 = BatchNormalization()(up3)
    up3 = Conv2D(first_filters*4, (3,3), activation='relu', padding='same', kernel_regularizer=l2(0.001))(up3)
    up3 = BatchNormalization()(up3)
    
    # up2 = UpSampling2D((2,2))(up3)
    up2 = Conv2DTranspose(first_filters*2, (2,2), activation='relu', strides=(2,2), padding='same', kernel_regularizer=l2(0.001))(up3)
    up2 = concatenate([up2, down2], axis=3)
    up2 = Dropout(0.25)(up2)
    up2 = Conv2D(first_filters*2, (3,3), activation='relu', padding='same', kernel_regularizer=l2(0.001))(up2)
    up2 = BatchNormalization()(up2)
    up2 = Conv2D(first_filters*2, (3,3), activation='relu', padding='same', kernel_regularizer=l2(0.001))(up2)
    up2 = BatchNormalization()(up2)
    
    # up1 = UpSampling2D((2,2))(up2)
    up1 = Conv2DTranspose(first_filters, (2,2), activation='relu', strides=(2,2), padding='same', kernel_regularizer=l2(0.001))(up2)
    up1 = concatenate([up1, down1], axis=3)
    up2 = Dropout(0.25)(up2)
    up1 = Conv2D(first_filters, (3,3), activation='relu', padding='same', kernel_regularizer=l2(0.001))(up1)
    up1 = BatchNormalization()(up1)
    up1 = Conv2D(first_filters, (3,3), activation='relu', padding='same', kernel_regularizer=l2(0.001))(up1)
    up1 = BatchNormalization()(up1)
    
    classify = Conv2D(num_classes, (1, 1), activation='sigmoid', kernel_regularizer=l2(0.001))(up1)
